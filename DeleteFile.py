...
vergit =  subprocess.check_output('git ls-remote https://github.com/izemkung/pi_softbiz_strem | head -1 | cut -f 1', shell=True)
...
if vergit != vercurrent and len(vercurrent) == len(vergit):
    ...
    if os.path.exists("/home/pi/tmp") == True:
        ...
        time.sleep(10)   
    print subprocess.check_output('sudo git clone https://github.com/izemkung/pi_softbiz_strem /home/pi/tmp', shell=True)
    time.sleep(10)
    if os.path.exists("/home/pi/tmp") == True:
